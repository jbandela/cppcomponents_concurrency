...
g++ -std=c++11 ../../implementation/cppcomponents_concurrency.cpp -I ../../../cppcomponents -I ../../ -shared -o cppcomponents_concurrency.so -lboost_coroutine -fPIC -fvisibility=hidden  -lboost_system -lboost_context -Wl,--no-undefined -O2 -ldl -pthread
